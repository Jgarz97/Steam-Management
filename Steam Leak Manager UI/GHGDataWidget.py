...
class GHGData(QWidget):
    def __init__(self):
        ...
        #stats_layout.addWidget(Gradient_Card("Orifice Calculations", "1000 lbs/h", title_colors, content_colors, ":/white_icons.qrc/droplet.svg"))
        #stats_layout.addWidget(Gradient_Card("Steam P/F Relationships", "1000 kWh", title_colors, content_colors, ":/white_icons.qrc/droplet.svg"))
        #stats_layout.addWidget(Gradient_Card("Cost Relationships", "400", title_colors, content_colors, ":/white_icons.qrc/droplet.svg"))
